...
$result = mysql_query("SELECT CO_No,CO_Description FROM Course_Outcome where Course_Id = '$cid' ");
if(!$result){
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
	  ...
	  <a class="navbar-brand" href='facultydash.php'>View CO for <?php print $cid ?> </a>
